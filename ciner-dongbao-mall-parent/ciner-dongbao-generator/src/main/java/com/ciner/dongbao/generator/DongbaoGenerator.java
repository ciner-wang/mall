package com.ciner.dongbao.generator;
...
public class DongbaoGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir(projectPath + "\\ciner-dongbao-service\\ciner-dongbao-ums\\src\\main\\java");
		...
		dsc.setUrl("jdbc:mysql://192.168.56.23:3307/dongbao_Test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
		...
		pc.setParent("com.ciner.cinerdongbaoums");
		pc.setEntity("entity");
		pc.setMapper("mapper");
